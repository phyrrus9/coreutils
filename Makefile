...
am__aclocal_m4_deps = $(top_srcdir)/m4/00gnulib.m4 \
	...
	$(top_srcdir)/m4/iswblank.m4 $(top_srcdir)/m4/jm-macros.m4 \
	...
	$(top_srcdir)/m4/ldexpl.m4 $(top_srcdir)/m4/lib-check.m4 \
	...
	$(top_srcdir)/m4/memcoll.m4 $(top_srcdir)/m4/mempcpy.m4 \
	...
	$(top_srcdir)/m4/xattr.m4 $(top_srcdir)/m4/xfts.m4 \
...
ACLOCAL = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run aclocal-1.11a
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run tar
AM_DEFAULT_VERBOSITY = 0
APPLE_UNIVERSAL_BUILD = 0
AR = ar
ARFLAGS = cru
AUTOCONF = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run automake-1.11a
AWK = awk
...
GNULIB_FCNTL = 1
GNULIB_FDATASYNC = 0
GNULIB_FDOPEN = IN_COREUTILS_GNULIB_TESTS
GNULIB_FDOPENDIR = 1
GNULIB_FFLUSH = 1
GNULIB_FFS = 0
GNULIB_FFSL = 0
...
GNULIB_FTELL = 1
GNULIB_FTELLO = 1
GNULIB_FTRUNCATE = IN_COREUTILS_GNULIB_TESTS
GNULIB_FUTIMENS = 1
GNULIB_FWRITE = 1
...
GNULIB_PIPE = IN_COREUTILS_GNULIB_TESTS
GNULIB_PIPE2 = 0
GNULIB_POPEN = 0
GNULIB_POWF = 0
GNULIB_PREAD = 0
...
GNULIB_UNLOCKPT = 0
GNULIB_UNSETENV = 1
GNULIB_USLEEP = IN_COREUTILS_GNULIB_TESTS
GNULIB_UTIMENSAT = 1
GNULIB_VASPRINTF = 1
GNULIB_VDPRINTF = 0
GNULIB_VFPRINTF = 1
...
HAVE__BOOL = 1
HAVE__EXIT = 1
HELP2MAN = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run help2man
HOSTENT_LIB = 
ICONV_CONST = 
ICONV_H = iconv.h
...
LDFLAGS = 
LIBCOREUTILS_LIBDEPS =  -liconv
LIBCOREUTILS_LTLIBDEPS =  -liconv
LIBICONV = -liconv
LIBINTL = 
LIBMULTITHREAD = -lpthread
LIBOBJS =  ${LIBOBJDIR}fd-reopen$U.o ${LIBOBJDIR}xfts$U.o ${LIBOBJDIR}strintcmp$U.o ${LIBOBJDIR}strnumcmp$U.o
LIBPTH = 
LIBPTH_PREFIX = 
LIBS = 
LIBSOCKET = 
...
LTLIBOBJS =  ${LIBOBJDIR}fd-reopen$U.lo ${LIBOBJDIR}xfts$U.lo ${LIBOBJDIR}strintcmp$U.lo ${LIBOBJDIR}strnumcmp$U.lo
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/missing --run makeinfo
MAN = chroot.1 hostid.1 nice.1 who.1 users.1 pinky.1 uptime.1 stty.1 df.1  base64.1 basename.1 cat.1 chcon.1 chgrp.1 chmod.1 chown.1 cksum.1 comm.1 cp.1 csplit.1 cut.1 date.1 dd.1 dir.1 dircolors.1 dirname.1 du.1 echo.1 env.1 expand.1 expr.1 factor.1 false.1 fmt.1 fold.1 install.1 groups.1 head.1 id.1 join.1 kill.1 link.1 ln.1 logname.1 ls.1 md5sum.1 mkdir.1 mkfifo.1 mknod.1 mktemp.1 mv.1 nl.1 nproc.1 nohup.1 od.1 paste.1 pathchk.1 pr.1 printenv.1 printf.1 ptx.1 pwd.1 readlink.1 rm.1 rmdir.1 runcon.1 seq.1 sha1sum.1 sha224sum.1 sha256sum.1 sha384sum.1 sha512sum.1 shred.1 shuf.1 sleep.1 sort.1 split.1 stat.1 sum.1 sync.1 tac.1 tail.1 tee.1 test.1 timeout.1 touch.1 tr.1 true.1 truncate.1 tsort.1 tty.1 uname.1 unexpand.1 uniq.1 unlink.1 vdir.1 wc.1 whoami.1 yes.1 
...
NO_INSTALL_PROGS_DEFAULT = arch hostname su
OBJEXT = o
OPTIONAL_BIN_PROGS = chroot$(EXEEXT) hostid$(EXEEXT) nice$(EXEEXT) who$(EXEEXT) users$(EXEEXT) pinky$(EXEEXT) uptime$(EXEEXT) stty$(EXEEXT) df$(EXEEXT) [$(EXEEXT) base64$(EXEEXT) basename$(EXEEXT) cat$(EXEEXT) chcon$(EXEEXT) chgrp$(EXEEXT) chmod$(EXEEXT) chown$(EXEEXT) cksum$(EXEEXT) comm$(EXEEXT) cp$(EXEEXT) csplit$(EXEEXT) cut$(EXEEXT) date$(EXEEXT) dd$(EXEEXT) dir$(EXEEXT) dircolors$(EXEEXT) dirname$(EXEEXT) du$(EXEEXT) echo$(EXEEXT) env$(EXEEXT) expand$(EXEEXT) expr$(EXEEXT) factor$(EXEEXT) false$(EXEEXT) fmt$(EXEEXT) fold$(EXEEXT) ginstall$(EXEEXT) groups$(EXEEXT) head$(EXEEXT) id$(EXEEXT) join$(EXEEXT) kill$(EXEEXT) link$(EXEEXT) ln$(EXEEXT) logname$(EXEEXT) ls$(EXEEXT) md5sum$(EXEEXT) mkdir$(EXEEXT) mkfifo$(EXEEXT) mknod$(EXEEXT) mktemp$(EXEEXT) mv$(EXEEXT) nl$(EXEEXT) nproc$(EXEEXT) nohup$(EXEEXT) od$(EXEEXT) paste$(EXEEXT) pathchk$(EXEEXT) pr$(EXEEXT) printenv$(EXEEXT) printf$(EXEEXT) ptx$(EXEEXT) pwd$(EXEEXT) readlink$(EXEEXT) rm$(EXEEXT) rmdir$(EXEEXT) runcon$(EXEEXT) seq$(EXEEXT) sha1sum$(EXEEXT) sha224sum$(EXEEXT) sha256sum$(EXEEXT) sha384sum$(EXEEXT) sha512sum$(EXEEXT) shred$(EXEEXT) shuf$(EXEEXT) sleep$(EXEEXT) sort$(EXEEXT) split$(EXEEXT) stat$(EXEEXT) sum$(EXEEXT) sync$(EXEEXT) tac$(EXEEXT) tail$(EXEEXT) tee$(EXEEXT) test$(EXEEXT) timeout$(EXEEXT) touch$(EXEEXT) tr$(EXEEXT) true$(EXEEXT) truncate$(EXEEXT) tsort$(EXEEXT) tty$(EXEEXT) uname$(EXEEXT) unexpand$(EXEEXT) uniq$(EXEEXT) unlink$(EXEEXT) vdir$(EXEEXT) wc$(EXEEXT) whoami$(EXEEXT) yes$(EXEEXT)
OPTIONAL_PKGLIB_PROGS = 
PACKAGE = coreutils
PACKAGE_BUGREPORT = bug-coreutils@gnu.org
PACKAGE_NAME = GNU coreutils
PACKAGE_STRING = GNU coreutils 8.14
...
YFLAGS = 
YIELD_LIB = 
abs_aux_dir = /Users/phyrrus9/Downloads/coreutils-8.14/build-aux
abs_builddir = /Users/phyrrus9/Downloads/coreutils-8.14
abs_srcdir = /Users/phyrrus9/Downloads/coreutils-8.14
abs_top_builddir = /Users/phyrrus9/Downloads/coreutils-8.14
abs_top_srcdir = /Users/phyrrus9/Downloads/coreutils-8.14
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  acl_entries.o asnprintf.o asprintf.o at-func2.o chdir-long.o chown.o error.o euidaccess.o faccessat.o fchmodat.o fchownat.o fclose.o fdopendir.o fflush.o fnmatch.o fpending.o fpurge.o fseek.o fseeko.o fstatat.o fsusage.o fts.o futimens.o getcwd.o getcwd-lgpl.o getgroups.o gethrxtime.o getopt.o getopt1.o getpass.o group-member.o isapipe.o isnanf.o isnanl.o lchown.o link.o linkat.o lstat.o mempcpy.o memrchr.o mkdirat.o mktime.o mountlist.o nanosleep.o obstack.o open.o openat.o openat-proc.o printf-args.o printf-parse.o putenv.o readlink.o readlinkat.o readutmp.o regex.o remove.o rename.o root-dev-ino.o rpmatch.o selinux-at.o setenv.o sig2str.o stat.o strerror.o strerror-override.o symlink.o unlink.o unlinkat.o utimensat.o vasnprintf.o vasprintf.o vfprintf.o vprintf.o wcswidth.o wcwidth.o
gl_LTLIBOBJS =  acl_entries.lo asnprintf.lo asprintf.lo at-func2.lo chdir-long.lo chown.lo error.lo euidaccess.lo faccessat.lo fchmodat.lo fchownat.lo fclose.lo fdopendir.lo fflush.lo fnmatch.lo fpending.lo fpurge.lo fseek.lo fseeko.lo fstatat.lo fsusage.lo fts.lo futimens.lo getcwd.lo getcwd-lgpl.lo getgroups.lo gethrxtime.lo getopt.lo getopt1.lo getpass.lo group-member.lo isapipe.lo isnanf.lo isnanl.lo lchown.lo link.lo linkat.lo lstat.lo mempcpy.lo memrchr.lo mkdirat.lo mktime.lo mountlist.lo nanosleep.lo obstack.lo open.lo openat.lo openat-proc.lo printf-args.lo printf-parse.lo putenv.lo readlink.lo readlinkat.lo readutmp.lo regex.lo remove.lo rename.lo root-dev-ino.lo rpmatch.lo selinux-at.lo setenv.lo sig2str.lo stat.lo strerror.lo strerror-override.lo symlink.lo unlink.lo unlinkat.lo utimensat.lo vasnprintf.lo vasprintf.lo vfprintf.lo vprintf.lo wcswidth.lo wcwidth.lo
gltests_LIBOBJS =  ioctl.o perror.o strerror_r.o symlinkat.o
gltests_LTLIBOBJS =  ioctl.lo perror.lo strerror_r.lo symlinkat.lo
...
install_sh = ${SHELL} /Users/phyrrus9/Downloads/coreutils-8.14/build-aux/install-sh
